...
class Bill1:
    def __init__(self, root):
        ...
        cust_frame.place(x=10,y=3,width=800,height=130)
        
        lbl_name=Label(cust_frame,text="Customer Name :",bg='white',font=('Bahnschrift',13,'bold'),padx=2,pady=6)
        lbl_name.place(x=20,y=7)
        
        e2_name=ttk.Entry(cust_frame,width=24,textvariable=self.c_name,font=('Bahnschrift',13,'bold'))
        e2_name.place(x=160,y=12)

        lbl_no=Label(cust_frame,text="Contact Number :",bg='white',font=('Bahnschrift',13,'bold'),padx=2,pady=6)
        lbl_no.place(x=20,y=50)
        
        e2_no=ttk.Entry(cust_frame,width=24,textvariable=self.c_contact,font=('Bahnschrift',13,'bold'))
        e2_no.place(x=160,y=55)
        
        lbl_address=Label(cust_frame,text="Customer Address:",bg='white',font=('Bahnschrift',13,'bold'),padx=2,pady=6)
        lbl_address.place(x=400,y=7)
        
        e3_address=ttk.Entry(cust_frame,width=24,textvariable=self.address,font=('Bahnschrift',13,'bold'))
        e3_address.place(x=560,y=7)
        
        lbl_type=Label(cust_frame,text="Order Type :",bg='white',font=('Bahnschrift',13,'bold'),padx=2,pady=6)
        lbl_type.place(x=430,y=50)
        
        e3_type=Label(cust_frame,text=" Take",bg='white',font=('Bahnschrift',13,'bold'),padx=2,pady=6)
        e3_type.place(x=525,y=50)
        ...
        lbl_img1.place(x=520,y=210,width=300,height=230)
